...
// Animation Styles
public enum NCVAnimationStyle {
    case noAnimation, topToBottom, bottomToTop, leftToRight, rightToLeft
}

// Action Types
public enum NCVActionType {
    case none, selector, closure
}

public enum NCVAlertButtonLayout {
    case horizontal, vertical
}
// Button sub-class
open class NCVButton: UIButton {
    var actionType = NCVActionType.none
...
// Example: NCVAlertView().showSuccess(self, title: "Test", subTitle: "Value").close()
open class NCVAlertViewResponder {
    let alertview: NCVAlertView
    
    // Initialisation and Title/Subtitle/Close functions
    public init(alertview: NCVAlertView) {
...
let uniqueAccessibilityIdentifier: String = "NCVAlertView"

public typealias DismissBlock = () -> Void

// The Main Class
open class NCVAlertView: UIViewController {
    
    public struct NCVAppearance {
    ...
    public struct NCVTimeoutConfiguration {
    ...
    var timeout: NCVTimeoutConfiguration?
    var showTimeoutTimer: Timer?
    var timeoutTimer: Timer?
    var dismissBlock : DismissBlock?
    fileprivate var inputs = [UITextField]()
    fileprivate var input = [UITextView]()
    internal var buttons = [NCVButton]()
    fileprivate var selfReference: NCVAlertView?
    
    public init(appearance: NCVAppearance) {
    ...
    fileprivate func setup() {
        ...
        if appearance.disableTapGesture == false {
            let tapGesture = UITapGestureRecognizer(target: self, action: #selector(NCVAlertView.tapped(_:)))
    ...
    override open func viewDidAppear(_ animated: Bool) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(NCVAlertView.keyboardWillShow(_:)), name:NSNotification.Name.UIKeyboardWillShow, object: nil);
        NotificationCenter.default.addObserver(self, selector: #selector(NCVAlertView.keyboardWillHide(_:)), name:NSNotification.Name.UIKeyboardWillHide, object: nil);
    }
    ...
    @discardableResult
    open func addButton(_ title:String, backgroundColor:UIColor? = nil, textColor:UIColor? = nil, showTimeout:NCVButton.ShowTimeoutConfiguration? = nil, action:@escaping ()->Void)->NCVButton {
        let btn = addButton(title, backgroundColor: backgroundColor, textColor: textColor, showTimeout: showTimeout)
        btn.actionType = NCVActionType.closure
        btn.action = action
        btn.addTarget(self, action:#selector(NCVAlertView.buttonTapped(_:)), for:.touchUpInside)
        btn.addTarget(self, action:#selector(NCVAlertView.buttonTapDown(_:)), for:[.touchDown, .touchDragEnter])
        btn.addTarget(self, action:#selector(NCVAlertView.buttonRelease(_:)), for:[.touchUpInside, .touchUpOutside, .touchCancel, .touchDragOutside] )
        return btn
    }
    
    @discardableResult
    open func addButton(_ title:String, backgroundColor:UIColor? = nil, textColor:UIColor? = nil, showTimeout:NCVButton.ShowTimeoutConfiguration? = nil, target:AnyObject, selector:Selector)->NCVButton {
        let btn = addButton(title, backgroundColor: backgroundColor, textColor: textColor, showTimeout: showTimeout)
        btn.actionType = NCVActionType.selector
        btn.target = target
    ...
    @discardableResult
    fileprivate func addButton(_ title:String, backgroundColor:UIColor? = nil, textColor:UIColor? = nil, showTimeout:NCVButton.ShowTimeoutConfiguration? = nil)->NCVButton {
        // Update view height
    ...
    @objc func buttonTapped(_ btn:NCVButton) {
        if btn.actionType == NCVActionType.closure {
            btn.action()
    ...
    @objc func buttonTapDown(_ btn:NCVButton) {
        var hue : CGFloat = 0
    ...
    @objc func buttonRelease(_ btn:NCVButton) {
    ...
    //Dismiss keyboard when tapped outside textfield & close NCVAlertView when hideWhenBackgroundViewIsTapped
    ...
    @discardableResult
    open func showCustom(_ title: String, subTitle: String, color: UIColor, icon: UIImage, closeButtonTitle:String?=nil, timeout:NCVTimeoutConfiguration?=nil, colorStyle: UInt=NCVAlertViewStyle.success.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: NCVAnimationStyle = .topToBottom) -> NCVAlertViewResponder {
    ...
    @discardableResult
    open func showSuccess(_ title: String, subTitle: String, closeButtonTitle:String?=nil, timeout:NCVTimeoutConfiguration?=nil, colorStyle: UInt=NCVAlertViewStyle.success.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: NCVAnimationStyle = .topToBottom) -> NCVAlertViewResponder {
    ...
    @discardableResult
    open func showError(_ title: String, subTitle: String, closeButtonTitle:String?=nil, timeout:NCVTimeoutConfiguration?=nil, colorStyle: UInt=NCVAlertViewStyle.error.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: NCVAnimationStyle = .topToBottom) -> NCVAlertViewResponder {
    ...
    @discardableResult
    open func showNotice(_ title: String, subTitle: String, closeButtonTitle:String?=nil, timeout:NCVTimeoutConfiguration?=nil, colorStyle: UInt=NCVAlertViewStyle.notice.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: NCVAnimationStyle = .topToBottom) -> NCVAlertViewResponder {
    ...
    @discardableResult
    open func showWarning(_ title: String, subTitle: String, closeButtonTitle:String?=nil, timeout:NCVTimeoutConfiguration?=nil, colorStyle: UInt=NCVAlertViewStyle.warning.defaultColorInt, colorTextButton: UInt=0x000000, circleIconImage: UIImage? = nil, animationStyle: NCVAnimationStyle = .topToBottom) -> NCVAlertViewResponder {
    ...
    @discardableResult
    open func showInfo(_ title: String, subTitle: String, closeButtonTitle:String?=nil, timeout:NCVTimeoutConfiguration?=nil, colorStyle: UInt=NCVAlertViewStyle.info.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: NCVAnimationStyle = .topToBottom) -> NCVAlertViewResponder {
    ...
    @discardableResult
    open func showWait(_ title: String, subTitle: String, closeButtonTitle:String?=nil, timeout:NCVTimeoutConfiguration?=nil, colorStyle: UInt?=NCVAlertViewStyle.wait.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: NCVAnimationStyle = .topToBottom) -> NCVAlertViewResponder {
    ...
    @discardableResult
    open func showEdit(_ title: String, subTitle: String, closeButtonTitle:String?=nil, timeout:NCVTimeoutConfiguration?=nil, colorStyle: UInt=NCVAlertViewStyle.edit.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: NCVAnimationStyle = .topToBottom) -> NCVAlertViewResponder {
    ...
    @discardableResult
    open func showTitle(_ title: String, subTitle: String, style: NCVAlertViewStyle, closeButtonTitle:String?=nil, timeout:NCVTimeoutConfiguration?=nil, colorStyle: UInt?=0x000000, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: NCVAnimationStyle = .topToBottom) -> NCVAlertViewResponder {
    ...
    @discardableResult
    open func showTitle(_ title: String, subTitle: String, timeout: NCVTimeoutConfiguration?, completeText: String?, style: NCVAlertViewStyle, colorStyle: UInt?=0x000000, colorTextButton: UInt?=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: NCVAnimationStyle = .topToBottom) -> NCVAlertViewResponder {
        selfReference = self
        view.alpha = 0
        view.tag = uniqueTag
        ...
        case .success:
            ...
            iconImage = checkCircleIconImage(circleIconImage, defaultImage: NCVAlertViewStyleKit.imageOfCheckmark)
            
        case .error:
            
            iconImage = checkCircleIconImage(circleIconImage, defaultImage: NCVAlertViewStyleKit.imageOfCross)
            
        case .notice:
            
            iconImage = checkCircleIconImage(circleIconImage, defaultImage:NCVAlertViewStyleKit.imageOfNotice)
            
        case .warning:
            
            iconImage = checkCircleIconImage(circleIconImage, defaultImage:NCVAlertViewStyleKit.imageOfWarning)
            
        case .info:
            
            iconImage = checkCircleIconImage(circleIconImage, defaultImage:NCVAlertViewStyleKit.imageOfInfo)
            
        case .edit:
            
            iconImage = checkCircleIconImage(circleIconImage, defaultImage:NCVAlertViewStyleKit.imageOfEdit)
            
        case .wait:
            iconImage = nil
            
        case .question:
            iconImage = checkCircleIconImage(circleIconImage, defaultImage:NCVAlertViewStyleKit.imageOfQuestion)
        }
        ...
        if appearance.showCloseButton {
            _ = addButton(completeText ?? "Done", target:self, selector:#selector(NCVAlertView.hideView))
        }
        ...
        if let timeout = timeout {
            ...
            timeoutTimer = Timer.scheduledTimer(timeInterval: timeout.value, target: self, selector: #selector(NCVAlertView.hideViewTimeout), userInfo: nil, repeats: false)
            showTimeoutTimer?.invalidate()
            showTimeoutTimer = Timer.scheduledTimer(timeInterval: 1.0, target: self, selector: #selector(NCVAlertView.updateShowTimeout), userInfo: nil, repeats: true)
        }
        ...
        // Chainable objects
        return NCVAlertViewResponder(alertview: self)
    }
    
    // Show animation in the alert view
    fileprivate func showAnimation(_ animationStyle: NCVAnimationStyle = .topToBottom, animationStartOffset: CGFloat = -400.0, boundingAnimationOffset: CGFloat = 15.0, animationDuration: TimeInterval = 0.2) {
    ...
    @objc open func hideView() {
        UIView.animate(withDuration: 0.2, animations: {
            ...
            // This is necessary for NCVAlertView to be de-initialized, preventing a strong reference cycle with the viewcontroller calling NCVAlertView.
    ...
    //Return true if a NCVAlertView is already being shown, false otherwise
...
class NCVAlertViewStyleKit : NSObject {
    ...
    class var imageOfCheckmark: UIImage {
        ...
        NCVAlertViewStyleKit.drawCheckmark()
    ...
    class var imageOfCross: UIImage {
        ...
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 80, height: 80), false, 0)
        NCVAlertViewStyleKit.drawCross()
    ...
    class var imageOfNotice: UIImage {
        ...
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 80, height: 80), false, 0)
        NCVAlertViewStyleKit.drawNotice()
    ...
    class var imageOfWarning: UIImage {
        ...
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 80, height: 80), false, 0)
        NCVAlertViewStyleKit.drawWarning()
    ...
    class var imageOfQuestion: UIImage {
        ...
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 80, height: 80), false, 0)
        NCVAlertViewStyleKit.drawQuestion()
